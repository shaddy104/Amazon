...
<html lang="en">
  <head>
    ...
    <meta name="author" content="P. Shadrach Sudershan(ppsder)">
    <link rel="icon" href="/docs/4.1/assets/img/favicons/favicon.ico">

    <title>Alaska Facility Center</title>
  ...
  <body>
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Alaska Facility Center</a>
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Alaska Facility Center - DOC-H3RD-00225566</h1>
		  ...
		  <?php
              $query = "SELECT * from `alaska` order by `date` DESC";
              if(count(fetchAll($query))>0){
		  ...
		  <div class="card">
			  <div class="card-body">
				...
				<a href="view.php?id=<?php echo $i['id'] ?>" class="btn btn-primary">yes</a>
				<a href="view.php?id=<?php echo $i['id'] ?>" class="btn btn-primary">No</a>
				<a href="view.php?id=<?php echo $i['id'] ?>" class="btn btn-primary">To Early</a>
				</div>
